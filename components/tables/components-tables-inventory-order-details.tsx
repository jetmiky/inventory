...
const ComponentsTablesInventoryOrderDetails = ({ order, details, onToggleOpenDiscountModal, onToggleOpenDetailModal, onDeleteDetail }: ComponentsTablesInventoryOrderDetailsProps) => {
    return (
        <div>
                        ...
                        {details.length ? (
                            <>
                                ...
                                <tr className="bg-gray-50 font-bold">
                                    ...
                                    <td className="max-w-1 whitespace-nowrap">Rp</td>
                                    <td className="text-right">{formatThousands(order?.tax || 0, '.')}</td>
                                    <td />
                                </tr>
                                <tr className="bg-gray-50 font-bold">
                                    <td colSpan={4} className="text-right">
                                    ...
                                    <td className="max-w-1 whitespace-nowrap">Rp</td>
                                    <td className="text-right">{formatThousands(order?.discount || 0, '.')}</td>
                                    <td />
                                </tr>
                                <tr className="bg-gray-100 font-bold">
                                    <td colSpan={4} className="text-right">
