                                ...
                                <div className="px-5 pt-3 pb-6">
                                    <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-4">
                                        <div>
                                            ...
                                            <input id="name" type="text" placeholder="Inventory Type Name" className="form-input" {...register('name')} required />
                                        </div>
                                        <div>
                                            <label htmlFor="description" className="text-sm">
                                                Description
                                            </label>
                                            <textarea id="description" placeholder="Inventory Type Description" className="form-input" {...register('description')} required />
                                        </div>
