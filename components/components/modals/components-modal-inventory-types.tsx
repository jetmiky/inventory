...
const ComponentsModalInventoryTypes = ({ isOpen, onToggleOpen }: ComponentsModalInventoryTypesProps) => {
    return (
        <div>
                                ...
                                <div className="p-5">
                                    <form className="space-y-5">
                                        <div>
                                            ...
                                            <input id="name" type="text" placeholder="Inventory Type Name" className="form-input" />
                                        </div>
                                    </form>
