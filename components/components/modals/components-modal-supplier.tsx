                                ...
                                <div className="px-5 pt-3 pb-6">
                                    <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-4">
                                        <div>
                                            ...
                                            <input id="name" type="text" placeholder="Supplier Name" className="form-input" {...register('name')} required />
                                        </div>
                                        <div>
                                            <label htmlFor="phone" className="text-sm">
                                                Phone
                                            </label>
                                            <input id="phone" type="text" placeholder="Supplier Phone" className="form-input" {...register('phone')} required />
                                        </div>
                                        <div>
                                            <label htmlFor="email" className="text-sm">
                                                Email
                                            </label>
                                            <input id="email" type="email" placeholder="Supplier Email" className="form-input" {...register('email')} required />
                                        </div>
                                        <div>
                                            <label htmlFor="address" className="text-sm">
                                                Address
                                            </label>
                                            <textarea id="address" placeholder="Supplier Address" className="form-input" {...register('address')} required />
                                        </div>
