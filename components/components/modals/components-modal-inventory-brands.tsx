...
type ComponentsModalInventoryBrandsProps = {
    isOpen: boolean;
    onToggleOpen: (state: boolean) => void;
};

const ComponentsModalInventoryBrands = ({ isOpen, onToggleOpen }: ComponentsModalInventoryBrandsProps) => {
    return (
        <div>
                                ...
                                <div className="p-5">
                                    <form className="space-y-5">
                                        <div>
                                            ...
                                            <input id="name" type="text" placeholder="Inventory Brand Name" className="form-input" />
                                        </div>
                                    </form>
...
export default ComponentsModalInventoryBrands;
